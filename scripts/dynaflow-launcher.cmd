...
set _test=%~2
if "%~2"=="" set _test=.*
cmake -S "%DYNAFLOW_LAUNCHER_HOME%" -B "%DYNAFLOW_LAUNCHER_BUILD_DIR%" -DUSE_MPI=%DYNAWO_USE_MPI% -DCMAKE_INSTALL_PREFIX="%DYNAFLOW_LAUNCHER_INSTALL%" -DDYNAFLOW_LAUNCHER_BUILD_TESTS=ON -DDYNAFLOW_LAUNCHER_REGEX_TESTS="%_test%" -DGTEST_ROOT="%DYNAWO_GTEST_HOME%" -DGMOCK_HOME="%DYNAWO_GMOCK_HOME%" -DCMAKE_BUILD_TYPE=%DYNAWO_BUILD_TYPE% -DDYNAWO_ALGORITHMS_HOME="%DYNAWO_ALGORITHMS_HOME%" -DDYNAWO_HOME="%DYNAWO_HOME%" -DDYNAFLOW_LAUNCHER_THIRD_PARTY_DIR="%DYNAFLOW_LAUNCHER_HOME%" -DDYNAWO_PYTHON_COMMAND="%DYNAWO_PYTHON_COMMAND%" -G "NMake Makefiles" -Wno-dev

...
if %DYNAWO_USE_MPI%==YES (
  ...
  "%DYNAFLOW_LAUNCHER_INSTALL%\bin\DynaFlowLauncher" --log-level %DYNAFLOW_LAUNCHER_LOG_LEVEL% --network %2 --config %3 --contingencies %4 %_nsa%
)
exit /B %ERRORLEVEL%
...
(
  echo cmake -S "%DYNAFLOW_LAUNCHER_HOME%" -B "%DYNAFLOW_LAUNCHER_BUILD_DIR%" -DUSE_MPI=%DYNAWO_USE_MPI% -DCMAKE_INSTALL_PREFIX="%DYNAFLOW_LAUNCHER_INSTALL%" -DDYNAFLOW_LAUNCHER_DEPLOY=%DYNAFLOW_LAUNCHER_DEPLOY% -DDYNAFLOW_LAUNCHER_BUILD_TESTS=OFF -DCMAKE_BUILD_TYPE=%DYNAWO_BUILD_TYPE% -DDYNAWO_ALGORITHMS_HOME="%DYNAWO_ALGORITHMS_HOME%" -DDYNAWO_HOME="%DYNAWO_HOME%" -DDYNAFLOW_LAUNCHER_THIRD_PARTY_DIR="%DYNAFLOW_LAUNCHER_HOME%" -DDYNAWO_PYTHON_COMMAND="%DYNAWO_PYTHON_COMMAND%" -G "NMake Makefiles" -Wno-dev
...
set _test=%~2
if "%~2"=="" set _test=.*
cmake -S "%DYNAFLOW_LAUNCHER_HOME%" -B "%DYNAFLOW_LAUNCHER_BUILD_DIR%" -DUSE_MPI=%DYNAWO_USE_MPI% -DCMAKE_INSTALL_PREFIX="%DYNAFLOW_LAUNCHER_INSTALL%" -DDYNAFLOW_LAUNCHER_BUILD_TESTS=ON -DDYNAFLOW_LAUNCHER_REGEX_TESTS="%_test%" -DGTEST_ROOT="%DYNAWO_GTEST_HOME%" -DGMOCK_HOME="%DYNAWO_GMOCK_HOME%" -DCMAKE_BUILD_TYPE=%DYNAWO_BUILD_TYPE% -DDYNAFLOW_LAUNCHER_HOME="%DYNAFLOW_LAUNCHER_HOME%" -DDYNAWO_ALGORITHMS_HOME="%DYNAWO_ALGORITHMS_HOME%" -DDYNAWO_HOME="%DYNAWO_HOME%" -DDYNAFLOW_LAUNCHER_THIRD_PARTY_DIR="%DYNAFLOW_LAUNCHER_HOME%" -DDYNAWO_PYTHON_COMMAND="%DYNAWO_PYTHON_COMMAND%" -G "NMake Makefiles" -Wno-dev
...
if defined DYNAFLOW_LAUNCHER_INSTALL set DYNAWO_RESOURCES_DIR=%DYNAFLOW_LAUNCHER_XSD%;%DYNAFLOW_LAUNCHER_INSTALL%\share

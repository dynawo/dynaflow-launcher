...
if __name__ == "__main__":
    ...
    for root, dir, files in os.walk(root_dir):
        ...
        for file in files:
            if file != "outputIIDM.xml" and not (file.startswith("constraints") and file.endswith(".xml"))  and file != "lostEquipments.xml" and not file.endswith(".dyd") and not file.endswith(".par"):
                continue

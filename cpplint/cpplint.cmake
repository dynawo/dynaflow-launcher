...
set(CPPLINT_PATH ${PROJECT_SOURCE_DIR}/cpplint/cpplint-wrapper.py)

find_package (Python COMPONENTS Interpreter)

if(NOT EXISTS "${PROJECT_SOURCE_DIR}/cpplint/cpplint.py")
  ...
  ExternalProject_Add(cpplint_download
    INSTALL_DIR         ${PROJECT_SOURCE_DIR}/cpplint
    DOWNLOAD_DIR        ${PROJECT_SOURCE_DIR}/cpplint
...
if(MSVC)
  add_custom_target(cpplint ALL
    ...
    COMMAND Python::Interpreter ${CPPLINT_PATH} --modified --filter=-build/header_guard ${PROJECT_SOURCE_DIR})
else()
  add_custom_target(cpplint ALL
    DEPENDS cpplint_download
    COMMAND Python::Interpreter ${CPPLINT_PATH} --modified ${PROJECT_SOURCE_DIR})
endif()

...
execute_process(COMMAND ${EXE}  --iidm=res/IEEE14.iidm --config=res/config_${TEST_NAME}.json RESULT_VARIABLE EXE_RESULT)
if(EXE_RESULT)
    message(FATAL_ERROR "Execution failed: ${EXE} --iidm=res/IEEE14.iidm --config=res/config_${TEST_NAME}.json")
endif()

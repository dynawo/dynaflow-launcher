...
\begin{itemize}
\item
  \href{https://github.com/dynawo/dynaflow-launcher/releases/download/v1.7.0/DynaFlowLauncher_Linux_v1.7.0.zip}{Linux}
\item
  \href{https://github.com/dynawo/dynaflow-launcher/releases/download/v1.7.0/DynaFlowLauncher_Windows_v1.7.0.zip}{Windows}
\end{itemize}

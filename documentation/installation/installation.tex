...
Dynaflow-launcher release is available on Github : \href{https://github.com/dynawo/dynaflow-launcher/releases/download/v1.3.2/DynaFlowLauncher_Linux_v1.3.2.zip}{Linux release}.

...
It is possible to have a different configuration for security analysis by adding parameters in the \textit{sa} array. The parameters contained in the \textit{sa} array will then override the parameters for N in the configuration file. If no parameters were previously specified for N, it will override the default parameters of the simulation.

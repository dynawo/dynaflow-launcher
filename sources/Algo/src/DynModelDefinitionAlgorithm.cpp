...
void
DynModelAlgorithm::connectMacroConnectionForMultipleShunts(const NodePtr& node) {
...
void
DynModelAlgorithm::connectMacroConnectionForSingleShunt(const inputs::Shunt& shunt) {

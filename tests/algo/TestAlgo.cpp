...
TEST(HvdcLine, base) {
  ...
  auto hvdcLineLCC = dfl::inputs::HvdcLine::build("HVDCLCCLine",
  ...
  auto hvdcLineVSC = dfl::inputs::HvdcLine::build("HVDCVSCLine",
                                                  ...
                                                  0.01,
                                                  0.01);
  auto hvdcLineBothInMainComponent = dfl::inputs::HvdcLine::build("HVDCLineBothInMain",
                                                                  dfl::inputs::HvdcLine::ConverterType::LCC,
                                                                  lccStationMain1,
                                                                  lccStationMain2,
                                                                  boost::none,
...
TEST(ContingencyValidation, base) {
  ...
  auto hvdc_line = dfl::inputs::HvdcLine::build("HVDC_LINE",
                                                dfl::inputs::HvdcLine::ConverterType::LCC,
                                                conv1,
                                                conv2,
                                                boost::none,
